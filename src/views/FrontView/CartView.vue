<template>
    ...
    <div class="text-end">
        ...
        type="button" @click="removeAllCart()">清空購物車</button>
      </div>
      <table class="table align-middle">
        ...
        <tbody>
          <tr v-for="cart in carts.carts" :key="cart.id">
            ...
            <td>
                <img :src="cart.product.imageUrl" alt="" class="object-fit-cover" height="100px">
            </td>
            <td>
              {{cart.product.title }}
            </td>
            <td>
              <div class="input-group input-group-sm">
                <div class="input-group mb-3">
                  ...
                  <input min="1" type="number" class="form-control text-end" v-model="cart.qty"
